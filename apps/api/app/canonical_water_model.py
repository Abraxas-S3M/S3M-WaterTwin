...
Vendored copy of ``packages/canonical_water_model`` (Phase 1) so the reference
API is self-contained. The real Phase 6 service imports the shared package
directly; this dashboard-phase stand-in vendors it to keep ``docker compose up``
a single command without cross-package build wiring.
"""
